            ...
            <div className="flex-1 space-y-6">
               ...
               <div className="flex gap-4">
                  <div className="px-6 py-3 bg-white/5 rounded-2xl border border-white/5">
                     <p className="text-[10px] font-black uppercase tracking-widest opacity-40 mb-1">Ticket Médio (Real)</p>
                     <p className="font-black text-lg">{formatCurrency(unitsInventory.soldCount > 0 ? unitsInventory.realizedValue / unitsInventory.soldCount : 0)}</p>
                  </div>
               </div>
            </div>
         </div>
