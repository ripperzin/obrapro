...
export default function Home() {
  const features = [
    {
      icon: <ScanText className="w-10 h-10 text-cyan-400" />,
    ...
    {
      icon: <Mic className="w-10 h-10 text-emerald-400" />,
    ...
    {
      icon: <Kanban className="w-10 h-10 text-orange-400" />,
      title: "Gestão Visual",
      description: "Acompanhe o progresso do projeto em tempo real. Utilize quadros Kanban e linhas do tempo interativas para uma visão clara de cada etapa.",
    ...
    <div className="min-h-screen bg-[#0f172a] text-foreground flex flex-col selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <header className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0f172a]/70 backdrop-blur-xl">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="http://localhost:3000" target="_blank" className="text-sm font-medium hover:text-primary transition-colors">
              Login
            </Link>
      ...
      <main className="flex-1 pt-24">
        ...
        <section className="relative py-20 lg:py-32 overflow-hidden">
          ...
          <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-green-500/10 rounded-full blur-[100px] -z-10" />
          ...
          <div className="container mx-auto px-4 text-center z-10">
            ...
            >
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
                Gestão de Obras <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-green-400 to-blue-500 animate-gradient-x">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                ...
                <Button size="lg" variant="outline" className="h-14 px-10 text-lg bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/30 text-white rounded-full backdrop-blur-sm transition-all" asChild>
                  <Link href="#features"><Play className="mr-2 w-5 h-5 fill-white" /> Ver Demonstração</Link>
                </Button>
              </div>
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className={`relative h-full rounded-[2rem] p-[1px] bg-gradient-to-b from-white/20 to-transparent group-hover:from-white/40 transition-all duration-500 overflow-hidden`}>
                      ...
                      <Card className="relative h-full bg-[#0b1121]/90 backdrop-blur-2xl border-0 rounded-[2rem] overflow-hidden">

                        {/* Top Shine inside card */}
                        <div className={`absolute top-0 inset-x-0 h-40 bg-gradient-to-b ${feature.gradient} opacity-10 group-hover:opacity-20 transition-all duration-500`} />

                        <CardHeader className="pt-10 pb-4 relative z-10 flex flex-col items-center text-center">
                          {/* Icon Container with Glow */}
                          <div className={`mb-6 p-4 rounded-2xl ${feature.iconBg} ring-1 ring-white/10 shadow-[0_0_30px_-5px_rgba(255,255,255,0.1)] group-hover:scale-110 transition-transform duration-500 relative`}>
                            <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${feature.gradient} opacity-20 blur-lg`} />
